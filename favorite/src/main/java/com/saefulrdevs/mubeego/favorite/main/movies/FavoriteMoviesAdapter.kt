...
class FavoriteMoviesAdapter: ListAdapter<Movie, FavoriteMoviesAdapter.MoviesViewHolder>(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MoviesViewHolder {
        val itemsSeasonDetailBinding = ItemMoviesFavoriteTvshowsBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    class MoviesViewHolder(private val binding: ItemMoviesFavoriteTvshowsBinding) : RecyclerView.ViewHolder(binding.root) {
